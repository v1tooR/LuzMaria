...
export function WhatsAppButton({
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', display: fullWidth ? 'block' : 'inline-block' }}>
      <Button variant={variant} size={size} fullWidth={fullWidth} iconLeft={icon} {...rest}>
        {children}
      </Button>
    </a>
  );
